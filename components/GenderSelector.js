...
import { TouchableOpacity, Text, StyleSheet, View,Dimensions, TextComponent } from 'react-native';
...
const GenderSelector = ({setFieldValue }) => {
  ...
  return (
    ...
    <TouchableOpacity style={[styles.buttonContainer,{
      ...
      <Text style={styles.buttonText}><Text style={{
        fontFamily:"Orbitron",
        }}>
        Male
        </Text>
    ...
    <TouchableOpacity style={[styles.buttonContainer,{
        ...
        backgroundColor:colorF,}]} onPress={()=>{
            setColorM("#fe81c8")
            setColorF("#fc0390")
            setIColorM("#fe81c8")
            setIColorF("#fe81c8")
